  ...
  * @param turningEncoderChannelB DIO input for the turning encoder channel B
  """
    ...
    def __init__(self,
        ...
        self.m_turningEncoder.configSensorInitializationStrategy(ctre.sensors.SensorInitializationStrategy.BootToAbsolutePosition)
        self.m_turningEncoder.configAbsoluteSensorRange(ctre.sensors.AbsoluteSensorRange.Signed_PlusMinus180)
        self.m_turningEncoder.configSensorDirection(tEncoderReversed)  # Do we need to inverse this for certain positions?
